...
{
    public class LoginCharacter : BaseCharacter<LoginClient>
    {
        private readonly ILogger _log = Log.ForContext<LoginCharacter>();

        public LoginCharacter(int id = 0, LoginClient client = null) : base(id, client)
        {
        }
        ...
        public static void Delete(int accountId, int characterId)
        {
            using var dbContext = new MapleDbContext();
