...
namespace RazzleServer.Common.Crypto
{
    ...
    public class FastAes
    {
        ...
        /// <summary>
        /// Creates a new instance of the AES crypto
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// FastAES equivalent of the RijndaelManagedTransform.TransformBlock
        /// </remarks>
        /// <param name="block">Block to transform</param>
        [SecuritySafeCritical]
        internal unsafe void TransformBlock(byte[] block)
        {
            fixed (byte* pBlock = block)
            {
                ...
                while (curRound < Rounds - 2)
                {
                    ...
                    r0 = Table0[c0 & 255] ^ Table1[(c1 >> 8) & 255] ^ Table2[(c2 >> 16) & 255] ^ Table3[c3 >> 24] ^
                         wk[0];
                    r1 = Table0[c1 & 255] ^ Table1[(c2 >> 8) & 255] ^ Table2[(c3 >> 16) & 255] ^ Table3[c0 >> 24] ^
                         wk[1];
                    r2 = Table0[c2 & 255] ^ Table1[(c3 >> 8) & 255] ^ Table2[(c0 >> 16) & 255] ^ Table3[c1 >> 24] ^
                         wk[2];
                    r3 = Table0[c3 & 255] ^ Table1[(c0 >> 8) & 255] ^ Table2[(c1 >> 16) & 255] ^ Table3[c2 >> 24] ^
                         wk[3];
                    wk = _workingKey[++curRound];
                    c0 = Table0[r0 & 255] ^ Table1[(r1 >> 8) & 255] ^ Table2[(r2 >> 16) & 255] ^ Table3[r3 >> 24] ^
                         wk[0];
                    c1 = Table0[r1 & 255] ^ Table1[(r2 >> 8) & 255] ^ Table2[(r3 >> 16) & 255] ^ Table3[r0 >> 24] ^
                         wk[1];
                    c2 = Table0[r2 & 255] ^ Table1[(r3 >> 8) & 255] ^ Table2[(r0 >> 16) & 255] ^ Table3[r1 >> 24] ^
                         wk[2];
                    c3 = Table0[r3 & 255] ^ Table1[(r0 >> 8) & 255] ^ Table2[(r1 >> 16) & 255] ^ Table3[r2 >> 24] ^
                         wk[3];
                }
                ...
                wk = _workingKey[++curRound];
                c0 = Sbox[r0 & 255] ^ ((uint) Sbox[(r1 >> 8) & 255] << 8) ^ ((uint) Sbox[(r2 >> 16) & 255] << 16) ^
                     ((uint) Sbox[r3 >> 24] << 24) ^ wk[0];
                c1 = Sbox[r1 & 255] ^ ((uint) Sbox[(r2 >> 8) & 255] << 8) ^ ((uint) Sbox[(r3 >> 16) & 255] << 16) ^
                     ((uint) Sbox[r0 >> 24] << 24) ^ wk[1];
                c2 = Sbox[r2 & 255] ^ ((uint) Sbox[(r3 >> 8) & 255] << 8) ^ ((uint) Sbox[(r0 >> 16) & 255] << 16) ^
                     ((uint) Sbox[r1 >> 24] << 24) ^ wk[2];
                c3 = Sbox[r3 & 255] ^ ((uint) Sbox[(r0 >> 8) & 255] << 8) ^ ((uint) Sbox[(r1 >> 16) & 255] << 16) ^
                     ((uint) Sbox[r2 >> 24] << 24) ^ wk[3];
        ...
        /// <summary>
        /// Generates the working key used in the crypto for the AddRoundKey functionality
        /// </summary>
        /// <param name="key">The key as bytes</param>
        /// <returns>A valid working key</returns>
        [SecuritySafeCritical]
        private static uint[][] GenerateWorkingKey(byte[] key)
        {
        ...
        private static readonly uint[] Table0 =
        {
        ...
        private static readonly uint[] Table1 =
        {
        ...
        private static readonly uint[] Table2 =
        {
        ...
        private static readonly uint[] Table3 =
        {
