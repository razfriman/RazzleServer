    ...
    public class MapleCipherProvider
{
        ...
        public MapleCipherProvider(ushort currentGameVersion, ushort initialBufferSize = 0x100)
        {
            RecvCipher = new MapleCipher(currentGameVersion, ServerConfig.Instance.AESKey);
            SendCipher = new MapleCipher(currentGameVersion, ServerConfig.Instance.AESKey);
