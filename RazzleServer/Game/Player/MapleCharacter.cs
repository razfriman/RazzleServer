...
namespace RazzleServer.Game.Player
{
    public class MapleCharacter : Character
    {
        ...
        public static void EnterChannel(MapleClient c)
        {
            ...
            var pw = new PacketWriter(ServerOperationCode.ENTER_MAP);
        ...
        public static void SendCSInfo(MapleClient c)
        {
            ...
            var pw = new PacketWriter(ServerOperationCode.ENTER_CASH_SHOP);
        ...
        public static void UpdateStats(MapleClient c, SortedDictionary<MapleCharacterStat, int> stats, bool enableActions)
        {
            ...
            var pw = new PacketWriter(ServerOperationCode.UPDATE_STATS);
        ...
        public static PacketWriter RemovePlayerFromMap(int Id)
        {
            ...
            var pw = new PacketWriter(ServerOperationCode.REMOVE_PLAYER);
            pw.WriteInt(Id);
            return pw;
        }
        ...
        {
            var pw = new PacketWriter(ServerOperationCode.SERVER_NOTICE); // SERVER_MESSAGE
            pw.WriteShort(type);
        ...
        public static PacketWriter ServerNotice(string message, byte type, int channel = 0, bool whisperIcon = false)
        {
            ...
            var pw = new PacketWriter(ServerOperationCode.SERVER_NOTICE);
        ...
        public static PacketWriter SpawnPlayer(MapleCharacter chr)
        {
            ...
            var pw = new PacketWriter(ServerOperationCode.SPAWN_PLAYER);
            pw.WriteInt(chr.ID);
            pw.WriteByte(chr.Level);
        ...
        {
            var pw = new PacketWriter(ServerOperationCode.KEYMAP);
        ...
        {
            var pw = new PacketWriter(ServerOperationCode.QUICK_SLOT);
            pw.WriteByte(1);
            if (binds.Length == 28)
            {
                for (int i = 0; i < 28; i++)
