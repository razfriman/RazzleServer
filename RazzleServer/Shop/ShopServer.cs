...
{
    public class ShopServer : MapleServer<ShopClient, ShopPacketHandler>
    {
        public ShopServer(AServerManager manager) : base(manager)
        {
            Port = ServerConfig.Instance.ShopPort;
        }
