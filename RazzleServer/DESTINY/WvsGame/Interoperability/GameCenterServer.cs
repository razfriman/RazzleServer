...
{
    public class GameCenterServer : ServerHandler<InteroperabilityOperationCode, InteroperabilityOperationCode, BlankCryptograph>
    {
        public GameCenterServer(IPEndPoint remoteEP, string code) : base(remoteEP, "Center server", new object[] { code }) { }
        ...
        public static void Main()
        {
            try
            {
                WvsGame.CenterConnection = new GameCenterServer(new IPEndPoint(
