...
namespace RazzleServer.Server.Server
{
    public abstract class AWorld : MapleKeyedCollection<byte, IGameServer>
    {
        ...
        public abstract void Send(PacketWriter pw, GameClient except = null);

        public abstract GameCharacter GetCharacterById(int id);

        public abstract GameCharacter GetCharacterByName(string name);
